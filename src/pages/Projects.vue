                ...
                <div class="columns">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content has-text-centered">
                                    SignColors allows players on your
                                    <a>#Minecraft</a> server to add colored text to signs.
                                    <br>
                                    <small>Spigot Plugin -
                                        <span id="signcolors">{{ signcolorsText }}</span> for Spigot 1.11.2<br> Updated at
                                        <span id="signcolors_updatetime">{{ signcolorsDate }}</span>
                                    </small>
                                </div>
                            </div>
                    ...
                    <div class="column is-one-third">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content has-text-centered">
                                    PlayerSupport allows players on your
                                    <a>#Minecraft</a> server to request help with a simple command.
                                    <br>
                                    <small>Spigot Plugin -
                                        <span id="playersupport">{{ playersupportText }}</span> for Spigot 1.11.2<br> Updated at
                                        <span id="playersupport_updatetime">{{ playersupportDate }}</span>
                                    </small>
                                </div>
                            </div>
                            <footer class="card-footer">
                    ...
                    <div class="column is-one-third">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="content has-text-centered">
                                    A simple
                                    <a>#Minecraft</a> Server Wrapper (for Spigot, Bukkit, ...), which provides a console for your browser
                                    <br>
...
export default {
  ...
  created() {
    ...
    axios
      .get("https://pluginapi.codehat.de/plugins/Syjzymgdz")
      .then(response => {
        this.signcolorsText = "v" + response.data.data.version;
        this.signcolorsDate = this.$moment(
    ...
    axios
      .get("https://pluginapi.codehat.de/plugins/Hk9Z34juG")
      .then(response => {
        this.playersupportText = "v" + response.data.data.version;
        this.playersupportDate = this.$moment(
          response.data.data.updated_at
        ).format("Do MMMM YYYY, HH:mm");
      })
      .catch(error => {
